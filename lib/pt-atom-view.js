...
export default class PtAtomView extends View {
  ...
  //   this.element.classList.add('pt-atom');
  //
  //   // Create message element
  //   const message = document.createElement('div');
  //   message.textContent = 'The PtAtom package is Alive! It\'s ALIVE!';
  ...
  open() {
    ...
    console.log(`searching root path: ${pwd}`);
    console.log(`searching command: ${ptcmd}`);
